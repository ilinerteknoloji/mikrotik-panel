...
export const access_token = mysqlTable(
  ...
  (table) => {
    return {
      ...
      access_token_token_unique: unique("access_token_token_unique").on(
        table.token,
      ),
    };
  },
...
export const refresh_token = mysqlTable(
  ...
  (table) => {
    return {
      ...
      refresh_token_token_unique: unique("refresh_token_token_unique").on(
        table.token,
      ),
    };
  },
...
export const users = mysqlTable(
  ...
  (table) => {
    return {
      ...
      users_phoneNumber_unique: unique("users_phoneNumber_unique").on(
        table.phoneNumber,
      ),
    };
  },
...
export const users_details = mysqlTable(
  "users_details",
  {
    id: int("id").autoincrement().notNull(),
    user_id: int("user_id")
  ...
  (table) => {
    return {
      users_details_id: primaryKey({
        columns: [table.id],
        name: "users_details_id",
      }),
      users_details_user_id_unique: unique("users_details_user_id_unique").on(
        table.user_id,
      ),
    };
  },
